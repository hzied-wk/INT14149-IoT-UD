...
#define BLYNK_TEMPLATE_ID "TMPL631IfXixz"
#define BLYNK_TEMPLATE_NAME "ThinghiemIoT"
#define BLYNK_AUTH_TOKEN "b4LwYLaGJH5_rPPPbiRoKiyyghahVTx3"
...
BLYNK_WRITE(V0) 
{
  int p = param.asInt();   // 0 hoặc 1 từ Switch
  digitalWrite(R_EN,p);
  if(p == LOW) Serial.println(" Động cơ dừng chạy: Switch OFF");
  else Serial.println("Động cơ đang chạy: Switch ON");
}
